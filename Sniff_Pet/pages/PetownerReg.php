...
<body id="page-top">
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav" style="height: 103;">
        <div class="container"><a class="navbar-brand" href="#page-top" style="color: rgb(250,204,0);width: 98;">SniffPet</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" data-toogle="collapse" aria-controls="navbarResponsive"
            ...
            <div class="login">
            	<form class="ginlog" style="padding: 2px;" autocomplete="off" action="petowner_login.php" method="POST">
...
<div style="height: maxlength; width: maxlength; background-color: #343233; margin-top: 100px; margin-left: px;">
	<div class="alert alert-info"><strong>Not Yet a member? Register Here...</strong></div>
	<div style="padding: 5px;">
		<form action="petowner_registration.php" method="POST" autocomplete="off">
			<div class="alert alert-success" style="height: maxlength; width: 49%; margin-left: 100px;margin-top: 20px;">
				<div class="alert alert-info"><strong>Personal Information...<span style="float: right;">Registration</span></strong></div>
					...
					<input type="text" name="contact" placeholder="Enter Phone Number" class="form-control" required="required" maxlength="11"><br>
