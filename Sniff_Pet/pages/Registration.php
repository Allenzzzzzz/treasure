...
<body id="page-top">
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav" style="height: 103;">
        <div class="container"><a class="navbar-brand" href="index.php" style="color: rgb(250,204,0);width: 98;">SniffPet</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" data-toogle="collapse" aria-controls="navbarResponsive"
            ...
            <div class="login">
            	<form class="ginlog" style="padding: 2px;" autocomplete="off" action="veterinarian_login.php" method="POST">
...
<div style="height: maxlength; width: maxlength; background-color: #343233; margin-top: 100px; margin-left: px;">
	...
	<div style="padding: 5px;">
		<form action="member_registration.php" method="POST" autocomplete="off">
			<div class="alert alert-success" style="height: maxlength; width: 49%; margin-left: 100px;margin-top: 10px;">
			...
			<div class="alert alert-success" style="height: maxlength; width: 34.7%; position: absolute; top: 26%; margin-top: 40px; margin-left: 800px;">
