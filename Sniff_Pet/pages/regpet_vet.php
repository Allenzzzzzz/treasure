<?php
	...
	if (isset($_POST['btnRegPet']))
	{
		...
		$age = $_POST['age'];
		$gender = $_POST['gender'];
		$owner = $_POST['petowner'];
		$image = $_FILES['image']['name'];
		$target = "../assets/img/".basename($_FILES['image']['name']);

		$query = "INSERT INTO pets(avatar,pet_name,pet_type,veterinarian,address,breed,age,gender,pet_owner)VALUES('$image','$pname','$ptype','$oname','$oadd','$pbreed','$age','$gender','$owner')";
